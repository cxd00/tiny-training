...
from algorithm.core.utils.logging import logger
...
def main():
    ...
    # create model
    model = build_mcu_model().cuda() if torch.cuda.is_available() else build_mcu_model()
    ...
    if configs.backward_config.enable_backward_config:
        from algorithm.core.utils.partial_backward import parsed_backward_config, prepare_model_for_backward_config, \
            get_all_conv_ops
